    ...
    <div id="main" class="main">
        ...
        <form method="post" action="?dir=ali&control=who&action=submit">
            <div id="gamemain">
                <table>
                    <tbody>
                    <tr><td class="title"><b>批发商名:</b></td><td><input type="text" name="name" size=40></td></tr>
                    <tr><td class="title"><b>批发商介绍:</b></td><td><input type="text" name="info" size=80></td></tr>
                    <tr><td class="title"><b>批发商链接:</b></td><td><input type="text" name="url" size=80></td></tr>
